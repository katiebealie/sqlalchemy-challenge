...
def precipitation():
    ...
    # Get precipitation data from last 12 months from the most recent date from Measurement table
...
def tobs():
    ...
    # Query tobs data from last 12 months from Measurement table
    ...
    # Create a dictionary and append to a list of tobs_list
    tobs_list = []
